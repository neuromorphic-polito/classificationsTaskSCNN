...
def main(datasetName, encoding, filterbank, channels, bins, structure, quartile):
    ...
    return runningTrain[selected], runningTest[selected], synapses, runningModel[selected]
...
if __name__ == '__main__':
    ...
    if flagCompute == True:
        ...
        modelCNNPruned.save(f'{sourceFolder}{datasetName}{filterbank}{channels}x{bins}{structure}{quartile}{encoding}.keras')
