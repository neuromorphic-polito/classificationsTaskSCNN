...
def main(datasetName, encoding, filterbank, channels, bins, structure, quantile):
    ...
    modelCNN = torch.load(f'{sourceFolder}{datasetName}{filterbank}{channels}x{bins}{structure}{quantile}{encoding}.pth', weights_only=False)
...
if __name__ == '__main__':
    ...
    if flagCompute == True:
        accuracyTrain, accuracyTest, synapses = main(datasetName, encoding, filterbank, channels, bins, structure, quantile)
